...
double arduinoFFT::MajorPeakNumber()
{
	double maxY = 0;
	uint16_t IndexOfMaxY = 0;
	//If sampling_frequency = 2 * max_frequency in signal,
	...
	//double interpolatedX = IndexOfMaxY * this->_samplingFrequency / this->_samples;
	return(IndexOfMaxY);
}

double arduinoFFT::MajorPeakAmplitude()
{
	double maxY = 0;
	uint16_t IndexOfMaxY = 0;
	//If sampling_frequency = 2 * max_frequency in signal,
...
double arduinoFFT:: GetFreqFFT(int i)
{	
	double interpolatedX = i * this->_samplingFrequency / this->_samples;
	return(interpolatedX);
}
